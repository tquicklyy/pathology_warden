...
public class SceneEndAnalysisWithAccController {
    ...
    @FXML
    private Button EndAnalysisMyDocumentsButton;
    ...
    public void openingClosingEditButtons(MouseEvent event) throws IOException {
        timelineForAnimationOpenCloseButton.getKeyFrames().clear();
        KeyValue keyValueEndAnalysisAddDotsButton, keyValueEndAnalysisDeleteDotsButton, keyValueEndAnalysisEditColorPicker, keyValueEndAnalysisEditColorPickerLabel, keyValueEndAnalysisEditAnchorPane;
        KeyFrame keyFrame;
        ...
        if (isEndAnalysisEditAnchorPaneClosed) {
            keyValueEndAnalysisAddDotsButton = new KeyValue(EndAnalysisAddDotsButton.layoutXProperty(), EndAnalysisAddDotsButtonLayOutX);
            keyValueEndAnalysisDeleteDotsButton = new KeyValue(EndAnalysisDeleteDotsButton.layoutXProperty(), EndAnalysisDeleteDotsButtonLayOutX);
            keyValueEndAnalysisEditColorPicker = new KeyValue(EndAnalysisEditColorPicker.layoutXProperty(), EndAnalysisEditColorPickerLayOutX);
            keyValueEndAnalysisEditColorPickerLabel = new KeyValue(EndAnalysisEditColorPickerLabel.layoutXProperty(), EndAnalysisEditColorPickerLabelLayOutX);

            keyValueEndAnalysisEditAnchorPane = new KeyValue(EndAnalysisEditAnchorPane.prefWidthProperty(), EndAnalysisEditOpenedAnchorPaneWidth);
            keyFrame = new KeyFrame(Duration.seconds(0.2), keyValueEndAnalysisAddDotsButton, keyValueEndAnalysisDeleteDotsButton, keyValueEndAnalysisEditColorPicker, keyValueEndAnalysisEditColorPickerLabel, keyValueEndAnalysisEditAnchorPane);
            timelineForAnimationOpenCloseButton.getKeyFrames().add(keyFrame);
            ...
            keyValueEndAnalysisEditAnchorPane = new KeyValue(EndAnalysisEditAnchorPane.prefWidthProperty(), EndAnalysisEditClosedAnchorPaneWidth);
            keyFrame = new KeyFrame(Duration.seconds(0.2), keyValueEndAnalysisEditAnchorPane);
            timelineForAnimationOpenCloseButton.getKeyFrames().add(keyFrame);
        ...
        timelineForAnimationOpenCloseButton.play();
    }

    @FXML
    void initialize() {
        EndAnalysisBorderPane.heightProperty().addListener((observable, oldValue, newValue) -> {
            if (newValue.intValue() < 610) {
                ...
                EndAnalysisMyDocumentsButton.setPrefHeight(30);
                EndAnalysisMyDocumentsButton.setPrefWidth(110);
                EndAnalysisMyDocumentsButton.setFont(Font.font("Arial Black", 10));
                ...
                EndAnalysisMyDocumentsButton.setPrefHeight(33);
                EndAnalysisMyDocumentsButton.setPrefWidth(120);
                EndAnalysisMyDocumentsButton.setFont(Font.font("Arial Black", 10.5));
                ...
                EndAnalysisMyDocumentsButton.setPrefHeight(36);
                EndAnalysisMyDocumentsButton.setPrefWidth(130);
                EndAnalysisMyDocumentsButton.setFont(Font.font("Arial Black", 11));
                ...
                EndAnalysisMyDocumentsButton.setPrefHeight(39);
                EndAnalysisMyDocumentsButton.setPrefWidth(140);
                EndAnalysisMyDocumentsButton.setFont(Font.font("Arial Black", 11.5));
                ...
                EndAnalysisMyDocumentsButton.setPrefHeight(42);
                EndAnalysisMyDocumentsButton.setPrefWidth(150);
                EndAnalysisMyDocumentsButton.setFont(Font.font("Arial Black", 12));
